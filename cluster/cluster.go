...
type Cluster interface {
	...
	ReallocResource(ctx context.Context, IDs []string, cpu float64, memory int64, bindCPU, memoryLimit types.TriOptions, volumes types.VolumeBindings) (chan *types.ReallocResourceMessage, error)
