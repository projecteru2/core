...
type Cluster interface {
	...
	ReallocResource(ctx context.Context, IDs []string, cpu float64, memory int64, volumes types.VolumeBindings, bindCpu bool, unbindCpu bool) (chan *types.ReallocResourceMessage, error)
