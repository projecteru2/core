...
func (c *Calcium) doReplaceWorkload(ctx context.Context, workload *types.Workload, opts *types.ReplaceOptions, index int) (*types.CreateWorkloadMessage, *types.RemoveWorkloadMessage, error) {
