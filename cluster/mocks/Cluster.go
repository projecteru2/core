...
// ReallocResource provides a mock function with given fields: ctx, IDs, cpu, memory, volumes, bindCPUOpt
func (_m *Cluster) ReallocResource(ctx context.Context, IDs []string, cpu float64, memory int64, volumes types.VolumeBindings, bindCPUOpt types.BindCPUOptions) (chan *types.ReallocResourceMessage, error) {
	ret := _m.Called(ctx, IDs, cpu, memory, volumes, bindCPUOpt)

	var r0 chan *types.ReallocResourceMessage
	if rf, ok := ret.Get(0).(func(context.Context, []string, float64, int64, types.VolumeBindings, types.BindCPUOptions) chan *types.ReallocResourceMessage); ok {
		r0 = rf(ctx, IDs, cpu, memory, volumes, bindCPUOpt)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(context.Context, []string, float64, int64, types.VolumeBindings, types.BindCPUOptions) error); ok {
		r1 = rf(ctx, IDs, cpu, memory, volumes, bindCPUOpt)
	} else {
		r1 = ret.Error(1)
	}
