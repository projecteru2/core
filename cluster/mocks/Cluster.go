...
func (_m *Cluster) NodeResource(ctx context.Context, nodename string, fix bool) (*types.NodeResource, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*types.NodeResource, error)); ok {
...
func (_m *Cluster) PodResource(ctx context.Context, podname string) (chan *types.NodeResource, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (chan *types.NodeResource, error)); ok {
		return rf(ctx, podname)
	}
...
func (_m *Cluster) RemoveWorkload(ctx context.Context, ids []string, force bool, step int) (chan *types.RemoveWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, bool, int) (chan *types.RemoveWorkloadMessage, error)); ok {
		return rf(ctx, ids, force, step)
	}
