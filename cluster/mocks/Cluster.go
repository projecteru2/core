...
func (_m *Cluster) ReallocResource(ctx context.Context, IDs []string, cpu float64, memory int64, volumes types.VolumeBindings, bindCPUOpt types.ReallocBindCPUOption) (chan *types.ReallocResourceMessage, error) {
