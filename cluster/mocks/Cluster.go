...
func (_m *Cluster) BuildImage(ctx context.Context, opts *types.BuildOptions) (chan *types.BuildImageMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.BuildOptions) (chan *types.BuildImageMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) CacheImage(ctx context.Context, opts *types.ImageOptions) (chan *types.CacheImageMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ImageOptions) (chan *types.CacheImageMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) CalculateCapacity(_a0 context.Context, _a1 *types.DeployOptions) (*types.CapacityMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.DeployOptions) (*types.CapacityMessage, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *Cluster) ControlWorkload(ctx context.Context, IDs []string, t string, force bool) (chan *types.ControlWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, string, bool) (chan *types.ControlWorkloadMessage, error)); ok {
		return rf(ctx, IDs, t, force)
	}
...
func (_m *Cluster) Copy(ctx context.Context, opts *types.CopyOptions) (chan *types.CopyMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.CopyOptions) (chan *types.CopyMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) CreateWorkload(ctx context.Context, opts *types.DeployOptions) (chan *types.CreateWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.DeployOptions) (chan *types.CreateWorkloadMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) DissociateWorkload(ctx context.Context, IDs []string) (chan *types.DissociateWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string) (chan *types.DissociateWorkloadMessage, error)); ok {
		return rf(ctx, IDs)
	}
...
func (_m *Cluster) GetNodeEngineInfo(ctx context.Context, nodename string) (*enginetypes.Info, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*enginetypes.Info, error)); ok {
		return rf(ctx, nodename)
	}
...
func (_m *Cluster) ListImage(ctx context.Context, opts *types.ImageOptions) (chan *types.ListImageMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ImageOptions) (chan *types.ListImageMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) ListNetworks(ctx context.Context, podname string, driver string) ([]*enginetypes.Network, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]*enginetypes.Network, error)); ok {
		return rf(ctx, podname, driver)
	}
...
func (_m *Cluster) ListPodNodes(_a0 context.Context, _a1 *types.ListNodesOptions) (<-chan *types.Node, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ListNodesOptions) (<-chan *types.Node, error)); ok {
		return rf(_a0, _a1)
	}
...
func (_m *Cluster) ListWorkloads(ctx context.Context, opts *types.ListWorkloadsOptions) ([]*types.Workload, error) {
	...
	var r0 []*types.Workload
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ListWorkloadsOptions) ([]*types.Workload, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) LogStream(ctx context.Context, opts *types.LogStreamOptions) (chan *types.LogStreamMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.LogStreamOptions) (chan *types.LogStreamMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) NodeResource(ctx context.Context, nodename string, fix bool) (*types.NodeResourceInfo, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, bool) (*types.NodeResourceInfo, error)); ok {
		return rf(ctx, nodename, fix)
	}
...
func (_m *Cluster) PodResource(ctx context.Context, podname string) (chan *types.NodeResourceInfo, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (chan *types.NodeResourceInfo, error)); ok {
		return rf(ctx, podname)
	}
...
func (_m *Cluster) RawEngine(ctx context.Context, opts *types.RawEngineOptions) (*types.RawEngineMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.RawEngineOptions) (*types.RawEngineMessage, error)); ok {
		return rf(ctx, opts)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *types.RawEngineOptions) *types.RawEngineMessage); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Cluster) RemoveImage(ctx context.Context, opts *types.ImageOptions) (chan *types.RemoveImageMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ImageOptions) (chan *types.RemoveImageMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) RemoveWorkload(ctx context.Context, IDs []string, force bool) (chan *types.RemoveWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, bool) (chan *types.RemoveWorkloadMessage, error)); ok {
		return rf(ctx, IDs, force)
	}
...
func (_m *Cluster) ReplaceWorkload(ctx context.Context, opts *types.ReplaceOptions) (chan *types.ReplaceWorkloadMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.ReplaceOptions) (chan *types.ReplaceWorkloadMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) RunAndWait(ctx context.Context, opts *types.DeployOptions, inCh <-chan []byte) ([]string, <-chan *types.AttachWorkloadMessage, error) {
	...
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.DeployOptions, <-chan []byte) ([]string, <-chan *types.AttachWorkloadMessage, error)); ok {
		return rf(ctx, opts, inCh)
	}
...
func (_m *Cluster) Send(ctx context.Context, opts *types.SendOptions) (chan *types.SendMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.SendOptions) (chan *types.SendMessage, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) SendLargeFile(ctx context.Context, opts chan *types.SendLargeFileOptions) chan *types.SendMessage {
	...
	var r0 chan *types.SendMessage
	if rf, ok := ret.Get(0).(func(context.Context, chan *types.SendLargeFileOptions) chan *types.SendMessage); ok {
		r0 = rf(ctx, opts)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(chan *types.SendMessage)
...
func (_m *Cluster) SetNode(ctx context.Context, opts *types.SetNodeOptions) (*types.Node, error) {
	...
	var r0 *types.Node
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.SetNodeOptions) (*types.Node, error)); ok {
		return rf(ctx, opts)
	}
...
func (_m *Cluster) SetWorkloadsStatus(ctx context.Context, status []*types.StatusMeta, ttls map[string]int64) ([]*types.StatusMeta, error) {
	...
	var r0 []*types.StatusMeta
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []*types.StatusMeta, map[string]int64) ([]*types.StatusMeta, error)); ok {
		return rf(ctx, status, ttls)
	}
...
func (_m *Cluster) WatchServiceStatus(_a0 context.Context) (<-chan types.ServiceStatus, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (<-chan types.ServiceStatus, error)); ok {
		return rf(_a0)
	}
