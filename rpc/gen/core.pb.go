...
type MemoryLimitOpt int32

const (
	MemoryLimitOpt_INHERIT MemoryLimitOpt = 0
	MemoryLimitOpt_SOFT    MemoryLimitOpt = 1
	MemoryLimitOpt_HARD    MemoryLimitOpt = 2
)

var MemoryLimitOpt_name = map[int32]string{
	0: "INHERIT",
	1: "SOFT",
	2: "HARD",
}

var MemoryLimitOpt_value = map[string]int32{
	"INHERIT": 0,
	"SOFT":    1,
	"HARD":    2,
}

func (x MemoryLimitOpt) String() string {
	return proto.EnumName(MemoryLimitOpt_name, int32(x))
}

func (MemoryLimitOpt) EnumDescriptor() ([]byte, []int) {
...
func (BuildImageOptions_BuildMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f7e43720d1edc0fe, []int{35, 0}
}
...
type ReallocOptions struct {
	...
	BindCpu              BindCPUOpt     `protobuf:"varint,5,opt,name=bind_cpu,json=bindCpu,proto3,enum=pb.BindCPUOpt" json:"bind_cpu,omitempty"`
	MemoryLimit          MemoryLimitOpt `protobuf:"varint,6,opt,name=memory_limit,json=memoryLimit,proto3,enum=pb.MemoryLimitOpt" json:"memory_limit,omitempty"`
	XXX_NoUnkeyedLiteral struct{}       `json:"-"`
	XXX_unrecognized     []byte         `json:"-"`
	XXX_sizecache        int32          `json:"-"`
}
...
func (m *ReallocOptions) GetBindCpu() BindCPUOpt {
	if m != nil {
		return m.BindCpu
	}
...
func (m *ReallocOptions) GetMemoryLimit() MemoryLimitOpt {
	if m != nil {
		return m.MemoryLimit
	}
	return MemoryLimitOpt_INHERIT
}
...
func init() {
	...
	proto.RegisterEnum("pb.MemoryLimitOpt", MemoryLimitOpt_name, MemoryLimitOpt_value)
...
var fileDescriptor_f7e43720d1edc0fe = []byte{
	...
	,
}
