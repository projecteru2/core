...
var file_rpc_gen_core_proto_rawDesc = []byte{
	...
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xb1, 0x0b, 0x0a,
	...
	0x45, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x06, 0x6f, 0x77, 0x6e, 0x65, 0x72, 0x73, 0x1a, 0x3b, 0x0a,
...
var file_rpc_gen_core_proto_msgTypes = make([]protoimpl.MessageInfo, 130)
var file_rpc_gen_core_proto_goTypes = []interface{}{
	...
	nil,                                 // 84: pb.Node.CpuEntry
	nil,                                 // 85: pb.Node.LabelsEntry
	nil,                                 // 86: pb.Node.InitCpuEntry
	nil,                                 // 87: pb.Node.NumaEntry
	nil,                                 // 88: pb.Node.NumaMemoryEntry
	nil,                                 // 89: pb.Node.InitVolumeEntry
	nil,                                 // 90: pb.Node.VolumeEntry
	nil,                                 // 91: pb.Node.InitNumaMemoryEntry
	nil,                                 // 92: pb.SetNodeOptions.DeltaCpuEntry
	nil,                                 // 93: pb.SetNodeOptions.DeltaNumaMemoryEntry
	nil,                                 // 94: pb.SetNodeOptions.NumaEntry
	nil,                                 // 95: pb.SetNodeOptions.LabelsEntry
	nil,                                 // 96: pb.SetNodeOptions.DeltaVolumeEntry
	nil,                                 // 97: pb.NodeFilter.LabelsEntry
	nil,                                 // 98: pb.Workload.LabelsEntry
	nil,                                 // 99: pb.Workload.PublishEntry
	nil,                                 // 100: pb.WorkloadStatus.NetworksEntry
	nil,                                 // 101: pb.WorkloadStatusStreamOptions.LabelsEntry
	nil,                                 // 102: pb.AddNodeOptions.LabelsEntry
	nil,                                 // 103: pb.AddNodeOptions.NumaEntry
	nil,                                 // 104: pb.AddNodeOptions.NumaMemoryEntry
	nil,                                 // 105: pb.AddNodeOptions.VolumeMapEntry
	nil,                                 // 106: pb.GetNodeOptions.LabelsEntry
	nil,                                 // 107: pb.ListNodesOptions.LabelsEntry
	nil,                                 // 108: pb.Build.EnvsEntry
	nil,                                 // 109: pb.Build.ArgsEntry
	nil,                                 // 110: pb.Build.LabelsEntry
	nil,                                 // 111: pb.Build.ArtifactsEntry
	nil,                                 // 112: pb.Build.CacheEntry
	nil,                                 // 113: pb.Builds.BuildsEntry
	nil,                                 // 114: pb.LogOptions.ConfigEntry
	nil,                                 // 115: pb.EntrypointOptions.SysctlsEntry
	nil,                                 // 116: pb.Resource.CpuEntry
	nil,                                 // 117: pb.Resource.VolumePlanLimitEntry
	nil,                                 // 118: pb.Resource.VolumePlanRequestEntry
	nil,                                 // 119: pb.Volume.VolumeEntry
	nil,                                 // 120: pb.DeployOptions.NetworksEntry
	nil,                                 // 121: pb.DeployOptions.LabelsEntry
	nil,                                 // 122: pb.DeployOptions.NodelabelsEntry
	nil,                                 // 123: pb.DeployOptions.DataEntry
	nil,                                 // 124: pb.DeployOptions.ModesEntry
	nil,                                 // 125: pb.DeployOptions.OwnersEntry
	nil,                                 // 126: pb.ReplaceOptions.FilterLabelsEntry
	nil,                                 // 127: pb.ReplaceOptions.CopyEntry
	nil,                                 // 128: pb.CopyOptions.TargetsEntry
	nil,                                 // 129: pb.SendOptions.DataEntry
	nil,                                 // 130: pb.SendOptions.ModesEntry
	nil,                                 // 131: pb.SendOptions.OwnersEntry
	nil,                                 // 132: pb.CreateWorkloadMessage.PublishEntry
	nil,                                 // 133: pb.CapacityMessage.NodeCapacitiesEntry
}
var file_rpc_gen_core_proto_depIdxs = []int32{
	...
	84,  // 4: pb.Node.cpu:type_name -> pb.Node.CpuEntry
	85,  // 5: pb.Node.labels:type_name -> pb.Node.LabelsEntry
	86,  // 6: pb.Node.init_cpu:type_name -> pb.Node.InitCpuEntry
	87,  // 7: pb.Node.numa:type_name -> pb.Node.NumaEntry
	88,  // 8: pb.Node.numa_memory:type_name -> pb.Node.NumaMemoryEntry
	89,  // 9: pb.Node.init_volume:type_name -> pb.Node.InitVolumeEntry
	90,  // 10: pb.Node.volume:type_name -> pb.Node.VolumeEntry
	91,  // 11: pb.Node.init_numa_memory:type_name -> pb.Node.InitNumaMemoryEntry
	17,  // 12: pb.Nodes.nodes:type_name -> pb.Node
	0,   // 13: pb.SetNodeOptions.status_opt:type_name -> pb.TriOpt
	92,  // 14: pb.SetNodeOptions.delta_cpu:type_name -> pb.SetNodeOptions.DeltaCpuEntry
	93,  // 15: pb.SetNodeOptions.delta_numa_memory:type_name -> pb.SetNodeOptions.DeltaNumaMemoryEntry
	94,  // 16: pb.SetNodeOptions.numa:type_name -> pb.SetNodeOptions.NumaEntry
	95,  // 17: pb.SetNodeOptions.labels:type_name -> pb.SetNodeOptions.LabelsEntry
	96,  // 18: pb.SetNodeOptions.delta_volume:type_name -> pb.SetNodeOptions.DeltaVolumeEntry
	0,   // 19: pb.SetNodeOptions.bypass_opt:type_name -> pb.TriOpt
	97,  // 20: pb.NodeFilter.labels:type_name -> pb.NodeFilter.LabelsEntry
	98,  // 21: pb.Workload.labels:type_name -> pb.Workload.LabelsEntry
	99,  // 22: pb.Workload.publish:type_name -> pb.Workload.PublishEntry
	26,  // 23: pb.Workload.status:type_name -> pb.WorkloadStatus
	53,  // 24: pb.Workload.resource:type_name -> pb.Resource
	100, // 25: pb.WorkloadStatus.networks:type_name -> pb.WorkloadStatus.NetworksEntry
	...
	101, // 28: pb.WorkloadStatusStreamOptions.labels:type_name -> pb.WorkloadStatusStreamOptions.LabelsEntry
	...
	102, // 34: pb.AddNodeOptions.labels:type_name -> pb.AddNodeOptions.LabelsEntry
	103, // 35: pb.AddNodeOptions.numa:type_name -> pb.AddNodeOptions.NumaEntry
	104, // 36: pb.AddNodeOptions.numa_memory:type_name -> pb.AddNodeOptions.NumaMemoryEntry
	105, // 37: pb.AddNodeOptions.volume_map:type_name -> pb.AddNodeOptions.VolumeMapEntry
	106, // 38: pb.GetNodeOptions.labels:type_name -> pb.GetNodeOptions.LabelsEntry
	42,  // 39: pb.GetNodeResourceOptions.opts:type_name -> pb.GetNodeOptions
	107, // 40: pb.ListNodesOptions.labels:type_name -> pb.ListNodesOptions.LabelsEntry
	108, // 41: pb.Build.envs:type_name -> pb.Build.EnvsEntry
	109, // 42: pb.Build.args:type_name -> pb.Build.ArgsEntry
	110, // 43: pb.Build.labels:type_name -> pb.Build.LabelsEntry
	111, // 44: pb.Build.artifacts:type_name -> pb.Build.ArtifactsEntry
	112, // 45: pb.Build.cache:type_name -> pb.Build.CacheEntry
	113, // 46: pb.Builds.builds:type_name -> pb.Builds.BuildsEntry
	...
	114, // 49: pb.LogOptions.config:type_name -> pb.LogOptions.ConfigEntry
	...
	115, // 53: pb.EntrypointOptions.sysctls:type_name -> pb.EntrypointOptions.SysctlsEntry
	116, // 54: pb.Resource.cpu:type_name -> pb.Resource.CpuEntry
	117, // 55: pb.Resource.volume_plan_limit:type_name -> pb.Resource.VolumePlanLimitEntry
	118, // 56: pb.Resource.volume_plan_request:type_name -> pb.Resource.VolumePlanRequestEntry
	119, // 57: pb.Volume.volume:type_name -> pb.Volume.VolumeEntry
	51,  // 58: pb.DeployOptions.entrypoint:type_name -> pb.EntrypointOptions
	120, // 59: pb.DeployOptions.networks:type_name -> pb.DeployOptions.NetworksEntry
	121, // 60: pb.DeployOptions.labels:type_name -> pb.DeployOptions.LabelsEntry
	122, // 61: pb.DeployOptions.nodelabels:type_name -> pb.DeployOptions.NodelabelsEntry
	3,   // 62: pb.DeployOptions.deploy_strategy:type_name -> pb.DeployOptions.Strategy
	123, // 63: pb.DeployOptions.data:type_name -> pb.DeployOptions.DataEntry
	...
	124, // 66: pb.DeployOptions.modes:type_name -> pb.DeployOptions.ModesEntry
	125, // 67: pb.DeployOptions.owners:type_name -> pb.DeployOptions.OwnersEntry
	55,  // 68: pb.ReplaceOptions.deployOpt:type_name -> pb.DeployOptions
	126, // 69: pb.ReplaceOptions.filter_labels:type_name -> pb.ReplaceOptions.FilterLabelsEntry
	127, // 70: pb.ReplaceOptions.copy:type_name -> pb.ReplaceOptions.CopyEntry
	128, // 71: pb.CopyOptions.targets:type_name -> pb.CopyOptions.TargetsEntry
	129, // 72: pb.SendOptions.data:type_name -> pb.SendOptions.DataEntry
	130, // 73: pb.SendOptions.modes:type_name -> pb.SendOptions.ModesEntry
	131, // 74: pb.SendOptions.owners:type_name -> pb.SendOptions.OwnersEntry
	64,  // 75: pb.BuildImageMessage.error_detail:type_name -> pb.ErrorDetail
	132, // 76: pb.CreateWorkloadMessage.publish:type_name -> pb.CreateWorkloadMessage.PublishEntry
	53,  // 77: pb.CreateWorkloadMessage.resource:type_name -> pb.Resource
	66,  // 78: pb.ReplaceWorkloadMessage.create:type_name -> pb.CreateWorkloadMessage
	70,  // 79: pb.ReplaceWorkloadMessage.remove:type_name -> pb.RemoveWorkloadMessage
	...
	133, // 83: pb.CapacityMessage.node_capacities:type_name -> pb.CapacityMessage.NodeCapacitiesEntry
	...
	62,  // 87: pb.DeployOptions.ModesEntry.value:type_name -> pb.FileMode
	61,  // 88: pb.DeployOptions.OwnersEntry.value:type_name -> pb.FileOwner
	59,  // 89: pb.CopyOptions.TargetsEntry.value:type_name -> pb.CopyPaths
	62,  // 90: pb.SendOptions.ModesEntry.value:type_name -> pb.FileMode
	61,  // 91: pb.SendOptions.OwnersEntry.value:type_name -> pb.FileOwner
	...
	40,  // 102: pb.CoreRPC.AddNode:input_type -> pb.AddNodeOptions
	41,  // 103: pb.CoreRPC.RemoveNode:input_type -> pb.RemoveNodeOptions
	44,  // 104: pb.CoreRPC.ListPodNodes:input_type -> pb.ListNodesOptions
	42,  // 105: pb.CoreRPC.GetNode:input_type -> pb.GetNodeOptions
	20,  // 106: pb.CoreRPC.SetNode:input_type -> pb.SetNodeOptions
	21,  // 107: pb.CoreRPC.SetNodeStatus:input_type -> pb.SetNodeStatusOptions
	22,  // 108: pb.CoreRPC.GetNodeStatus:input_type -> pb.GetNodeStatusOptions
	4,   // 109: pb.CoreRPC.NodeStatusStream:input_type -> pb.Empty
	43,  // 110: pb.CoreRPC.GetNodeResource:input_type -> pb.GetNodeResourceOptions
	55,  // 111: pb.CoreRPC.CalculateCapacity:input_type -> pb.DeployOptions
	32,  // 112: pb.CoreRPC.GetWorkload:input_type -> pb.WorkloadID
	33,  // 113: pb.CoreRPC.GetWorkloads:input_type -> pb.WorkloadIDs
	7,   // 114: pb.CoreRPC.ListWorkloads:input_type -> pb.ListWorkloadsOptions
	42,  // 115: pb.CoreRPC.ListNodeWorkloads:input_type -> pb.GetNodeOptions
	33,  // 116: pb.CoreRPC.GetWorkloadsStatus:input_type -> pb.WorkloadIDs
	28,  // 117: pb.CoreRPC.SetWorkloadsStatus:input_type -> pb.SetWorkloadsStatusOptions
	29,  // 118: pb.CoreRPC.WorkloadStatusStream:input_type -> pb.WorkloadStatusStreamOptions
	60,  // 119: pb.CoreRPC.Copy:input_type -> pb.CopyOptions
	63,  // 120: pb.CoreRPC.Send:input_type -> pb.SendOptions
	47,  // 121: pb.CoreRPC.BuildImage:input_type -> pb.BuildImageOptions
	57,  // 122: pb.CoreRPC.CacheImage:input_type -> pb.CacheImageOptions
	58,  // 123: pb.CoreRPC.RemoveImage:input_type -> pb.RemoveImageOptions
	55,  // 124: pb.CoreRPC.CreateWorkload:input_type -> pb.DeployOptions
	56,  // 125: pb.CoreRPC.ReplaceWorkload:input_type -> pb.ReplaceOptions
	34,  // 126: pb.CoreRPC.RemoveWorkload:input_type -> pb.RemoveWorkloadOptions
	35,  // 127: pb.CoreRPC.DissociateWorkload:input_type -> pb.DissociateWorkloadOptions
	77,  // 128: pb.CoreRPC.ControlWorkload:input_type -> pb.ControlWorkloadOptions
	81,  // 129: pb.CoreRPC.ExecuteWorkload:input_type -> pb.ExecuteWorkloadOptions
	36,  // 130: pb.CoreRPC.ReallocResource:input_type -> pb.ReallocOptions
	79,  // 131: pb.CoreRPC.LogStream:input_type -> pb.LogStreamOptions
	76,  // 132: pb.CoreRPC.RunAndWait:input_type -> pb.RunAndWaitOptions
	5,   // 133: pb.CoreRPC.Info:output_type -> pb.CoreInfo
	6,   // 134: pb.CoreRPC.WatchServiceStatus:output_type -> pb.ServiceStatus
	16,  // 135: pb.CoreRPC.ListNetworks:output_type -> pb.Networks
	15,  // 136: pb.CoreRPC.ConnectNetwork:output_type -> pb.Network
	4,   // 137: pb.CoreRPC.DisconnectNetwork:output_type -> pb.Empty
	8,   // 138: pb.CoreRPC.AddPod:output_type -> pb.Pod
	4,   // 139: pb.CoreRPC.RemovePod:output_type -> pb.Empty
	8,   // 140: pb.CoreRPC.GetPod:output_type -> pb.Pod
	9,   // 141: pb.CoreRPC.ListPods:output_type -> pb.Pods
	10,  // 142: pb.CoreRPC.GetPodResource:output_type -> pb.PodResource
	17,  // 143: pb.CoreRPC.AddNode:output_type -> pb.Node
	4,   // 144: pb.CoreRPC.RemoveNode:output_type -> pb.Empty
	18,  // 145: pb.CoreRPC.ListPodNodes:output_type -> pb.Nodes
	17,  // 146: pb.CoreRPC.GetNode:output_type -> pb.Node
	17,  // 147: pb.CoreRPC.SetNode:output_type -> pb.Node
	4,   // 148: pb.CoreRPC.SetNodeStatus:output_type -> pb.Empty
	23,  // 149: pb.CoreRPC.GetNodeStatus:output_type -> pb.NodeStatusStreamMessage
	23,  // 150: pb.CoreRPC.NodeStatusStream:output_type -> pb.NodeStatusStreamMessage
	11,  // 151: pb.CoreRPC.GetNodeResource:output_type -> pb.NodeResource
	82,  // 152: pb.CoreRPC.CalculateCapacity:output_type -> pb.CapacityMessage
	25,  // 153: pb.CoreRPC.GetWorkload:output_type -> pb.Workload
	31,  // 154: pb.CoreRPC.GetWorkloads:output_type -> pb.Workloads
	25,  // 155: pb.CoreRPC.ListWorkloads:output_type -> pb.Workload
	31,  // 156: pb.CoreRPC.ListNodeWorkloads:output_type -> pb.Workloads
	27,  // 157: pb.CoreRPC.GetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	27,  // 158: pb.CoreRPC.SetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	30,  // 159: pb.CoreRPC.WorkloadStatusStream:output_type -> pb.WorkloadStatusStreamMessage
	73,  // 160: pb.CoreRPC.Copy:output_type -> pb.CopyMessage
	74,  // 161: pb.CoreRPC.Send:output_type -> pb.SendMessage
	65,  // 162: pb.CoreRPC.BuildImage:output_type -> pb.BuildImageMessage
	68,  // 163: pb.CoreRPC.CacheImage:output_type -> pb.CacheImageMessage
	69,  // 164: pb.CoreRPC.RemoveImage:output_type -> pb.RemoveImageMessage
	66,  // 165: pb.CoreRPC.CreateWorkload:output_type -> pb.CreateWorkloadMessage
	67,  // 166: pb.CoreRPC.ReplaceWorkload:output_type -> pb.ReplaceWorkloadMessage
	70,  // 167: pb.CoreRPC.RemoveWorkload:output_type -> pb.RemoveWorkloadMessage
	71,  // 168: pb.CoreRPC.DissociateWorkload:output_type -> pb.DissociateWorkloadMessage
	78,  // 169: pb.CoreRPC.ControlWorkload:output_type -> pb.ControlWorkloadMessage
	75,  // 170: pb.CoreRPC.ExecuteWorkload:output_type -> pb.AttachWorkloadMessage
	72,  // 171: pb.CoreRPC.ReallocResource:output_type -> pb.ReallocResourceMessage
	80,  // 172: pb.CoreRPC.LogStream:output_type -> pb.LogStreamMessage
	75,  // 173: pb.CoreRPC.RunAndWait:output_type -> pb.AttachWorkloadMessage
