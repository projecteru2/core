...
var file_rpc_gen_core_proto_rawDesc = []byte{
	...
	0x01, 0x22, 0xa2, 0x01, 0x0a, 0x0b, 0x46, 0x69, 0x6c, 0x65, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e,
	0x73, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x03,
	...
	0x05, 0x63, 0x68, 0x75, 0x6e, 0x6b, 0x22, 0x3b, 0x0a, 0x0b, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x44,
	...
	0xdd, 0x02, 0x0a, 0x15, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x57, 0x6f, 0x72, 0x6b, 0x6c, 0x6f,
	...
	0x01, 0x28, 0x0c, 0x52, 0x04, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x28, 0x0a, 0x08, 0x72, 0x65, 0x73,
	0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x70, 0x62,
	0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x52, 0x08, 0x72, 0x65, 0x73, 0x6f, 0x75,
	0x72, 0x63, 0x65, 0x1a, 0x3a, 0x0a, 0x0c, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x45, 0x6e,
	0x74, 0x72, 0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02,
	...
	0xff, 0xff, 0xff, 0x01, 0x32, 0xfa, 0x14, 0x0a, 0x07, 0x43, 0x6f, 0x72, 0x65, 0x52, 0x50, 0x43,
...
var file_rpc_gen_core_proto_depIdxs = []int32{
	...
	63,  // 74: pb.FileOptions.mode:type_name -> pb.FileMode
	62,  // 75: pb.FileOptions.owner:type_name -> pb.FileOwner
	66,  // 76: pb.BuildImageMessage.error_detail:type_name -> pb.ErrorDetail
	136, // 77: pb.CreateWorkloadMessage.publish:type_name -> pb.CreateWorkloadMessage.PublishEntry
	...
	137, // 85: pb.CapacityMessage.node_capacities:type_name -> pb.CapacityMessage.NodeCapacitiesEntry
	...
	4,   // 94: pb.CoreRPC.Info:input_type -> pb.Empty
	4,   // 95: pb.CoreRPC.WatchServiceStatus:input_type -> pb.Empty
	12,  // 96: pb.CoreRPC.ListNetworks:input_type -> pb.ListNetworkOptions
	13,  // 97: pb.CoreRPC.ConnectNetwork:input_type -> pb.ConnectNetworkOptions
	14,  // 98: pb.CoreRPC.DisconnectNetwork:input_type -> pb.DisconnectNetworkOptions
	37,  // 99: pb.CoreRPC.AddPod:input_type -> pb.AddPodOptions
	38,  // 100: pb.CoreRPC.RemovePod:input_type -> pb.RemovePodOptions
	39,  // 101: pb.CoreRPC.GetPod:input_type -> pb.GetPodOptions
	4,   // 102: pb.CoreRPC.ListPods:input_type -> pb.Empty
	39,  // 103: pb.CoreRPC.GetPodResource:input_type -> pb.GetPodOptions
	39,  // 104: pb.CoreRPC.PodResourceStream:input_type -> pb.GetPodOptions
	40,  // 105: pb.CoreRPC.AddNode:input_type -> pb.AddNodeOptions
	41,  // 106: pb.CoreRPC.RemoveNode:input_type -> pb.RemoveNodeOptions
	44,  // 107: pb.CoreRPC.ListPodNodes:input_type -> pb.ListNodesOptions
	44,  // 108: pb.CoreRPC.PodNodesStream:input_type -> pb.ListNodesOptions
	42,  // 109: pb.CoreRPC.GetNode:input_type -> pb.GetNodeOptions
	20,  // 110: pb.CoreRPC.SetNode:input_type -> pb.SetNodeOptions
	21,  // 111: pb.CoreRPC.SetNodeStatus:input_type -> pb.SetNodeStatusOptions
	22,  // 112: pb.CoreRPC.GetNodeStatus:input_type -> pb.GetNodeStatusOptions
	4,   // 113: pb.CoreRPC.NodeStatusStream:input_type -> pb.Empty
	43,  // 114: pb.CoreRPC.GetNodeResource:input_type -> pb.GetNodeResourceOptions
	55,  // 115: pb.CoreRPC.CalculateCapacity:input_type -> pb.DeployOptions
	32,  // 116: pb.CoreRPC.GetWorkload:input_type -> pb.WorkloadID
	33,  // 117: pb.CoreRPC.GetWorkloads:input_type -> pb.WorkloadIDs
	7,   // 118: pb.CoreRPC.ListWorkloads:input_type -> pb.ListWorkloadsOptions
	42,  // 119: pb.CoreRPC.ListNodeWorkloads:input_type -> pb.GetNodeOptions
	33,  // 120: pb.CoreRPC.GetWorkloadsStatus:input_type -> pb.WorkloadIDs
	28,  // 121: pb.CoreRPC.SetWorkloadsStatus:input_type -> pb.SetWorkloadsStatusOptions
	29,  // 122: pb.CoreRPC.WorkloadStatusStream:input_type -> pb.WorkloadStatusStreamOptions
	61,  // 123: pb.CoreRPC.Copy:input_type -> pb.CopyOptions
	64,  // 124: pb.CoreRPC.Send:input_type -> pb.SendOptions
	65,  // 125: pb.CoreRPC.SendLargeFile:input_type -> pb.FileOptions
	47,  // 126: pb.CoreRPC.BuildImage:input_type -> pb.BuildImageOptions
	57,  // 127: pb.CoreRPC.CacheImage:input_type -> pb.CacheImageOptions
	58,  // 128: pb.CoreRPC.RemoveImage:input_type -> pb.RemoveImageOptions
	59,  // 129: pb.CoreRPC.ListImage:input_type -> pb.ListImageOptions
	55,  // 130: pb.CoreRPC.CreateWorkload:input_type -> pb.DeployOptions
	56,  // 131: pb.CoreRPC.ReplaceWorkload:input_type -> pb.ReplaceOptions
	34,  // 132: pb.CoreRPC.RemoveWorkload:input_type -> pb.RemoveWorkloadOptions
	35,  // 133: pb.CoreRPC.DissociateWorkload:input_type -> pb.DissociateWorkloadOptions
	81,  // 134: pb.CoreRPC.ControlWorkload:input_type -> pb.ControlWorkloadOptions
	85,  // 135: pb.CoreRPC.ExecuteWorkload:input_type -> pb.ExecuteWorkloadOptions
	36,  // 136: pb.CoreRPC.ReallocResource:input_type -> pb.ReallocOptions
	83,  // 137: pb.CoreRPC.LogStream:input_type -> pb.LogStreamOptions
	80,  // 138: pb.CoreRPC.RunAndWait:input_type -> pb.RunAndWaitOptions
	5,   // 139: pb.CoreRPC.Info:output_type -> pb.CoreInfo
	6,   // 140: pb.CoreRPC.WatchServiceStatus:output_type -> pb.ServiceStatus
	16,  // 141: pb.CoreRPC.ListNetworks:output_type -> pb.Networks
	15,  // 142: pb.CoreRPC.ConnectNetwork:output_type -> pb.Network
	4,   // 143: pb.CoreRPC.DisconnectNetwork:output_type -> pb.Empty
	8,   // 144: pb.CoreRPC.AddPod:output_type -> pb.Pod
	4,   // 145: pb.CoreRPC.RemovePod:output_type -> pb.Empty
	8,   // 146: pb.CoreRPC.GetPod:output_type -> pb.Pod
	9,   // 147: pb.CoreRPC.ListPods:output_type -> pb.Pods
	10,  // 148: pb.CoreRPC.GetPodResource:output_type -> pb.PodResource
	11,  // 149: pb.CoreRPC.PodResourceStream:output_type -> pb.NodeResource
	17,  // 150: pb.CoreRPC.AddNode:output_type -> pb.Node
	4,   // 151: pb.CoreRPC.RemoveNode:output_type -> pb.Empty
	18,  // 152: pb.CoreRPC.ListPodNodes:output_type -> pb.Nodes
	17,  // 153: pb.CoreRPC.PodNodesStream:output_type -> pb.Node
	17,  // 154: pb.CoreRPC.GetNode:output_type -> pb.Node
	17,  // 155: pb.CoreRPC.SetNode:output_type -> pb.Node
	4,   // 156: pb.CoreRPC.SetNodeStatus:output_type -> pb.Empty
	23,  // 157: pb.CoreRPC.GetNodeStatus:output_type -> pb.NodeStatusStreamMessage
	23,  // 158: pb.CoreRPC.NodeStatusStream:output_type -> pb.NodeStatusStreamMessage
	11,  // 159: pb.CoreRPC.GetNodeResource:output_type -> pb.NodeResource
	86,  // 160: pb.CoreRPC.CalculateCapacity:output_type -> pb.CapacityMessage
	25,  // 161: pb.CoreRPC.GetWorkload:output_type -> pb.Workload
	31,  // 162: pb.CoreRPC.GetWorkloads:output_type -> pb.Workloads
	25,  // 163: pb.CoreRPC.ListWorkloads:output_type -> pb.Workload
	31,  // 164: pb.CoreRPC.ListNodeWorkloads:output_type -> pb.Workloads
	27,  // 165: pb.CoreRPC.GetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	27,  // 166: pb.CoreRPC.SetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	30,  // 167: pb.CoreRPC.WorkloadStatusStream:output_type -> pb.WorkloadStatusStreamMessage
	77,  // 168: pb.CoreRPC.Copy:output_type -> pb.CopyMessage
	78,  // 169: pb.CoreRPC.Send:output_type -> pb.SendMessage
	78,  // 170: pb.CoreRPC.SendLargeFile:output_type -> pb.SendMessage
	67,  // 171: pb.CoreRPC.BuildImage:output_type -> pb.BuildImageMessage
	70,  // 172: pb.CoreRPC.CacheImage:output_type -> pb.CacheImageMessage
	71,  // 173: pb.CoreRPC.RemoveImage:output_type -> pb.RemoveImageMessage
	73,  // 174: pb.CoreRPC.ListImage:output_type -> pb.ListImageMessage
	68,  // 175: pb.CoreRPC.CreateWorkload:output_type -> pb.CreateWorkloadMessage
	69,  // 176: pb.CoreRPC.ReplaceWorkload:output_type -> pb.ReplaceWorkloadMessage
	74,  // 177: pb.CoreRPC.RemoveWorkload:output_type -> pb.RemoveWorkloadMessage
	75,  // 178: pb.CoreRPC.DissociateWorkload:output_type -> pb.DissociateWorkloadMessage
	82,  // 179: pb.CoreRPC.ControlWorkload:output_type -> pb.ControlWorkloadMessage
	79,  // 180: pb.CoreRPC.ExecuteWorkload:output_type -> pb.AttachWorkloadMessage
	76,  // 181: pb.CoreRPC.ReallocResource:output_type -> pb.ReallocResourceMessage
	84,  // 182: pb.CoreRPC.LogStream:output_type -> pb.LogStreamMessage
	79,  // 183: pb.CoreRPC.RunAndWait:output_type -> pb.AttachWorkloadMessage
	139, // [139:184] is the sub-list for method output_type
	94,  // [94:139] is the sub-list for method input_type
