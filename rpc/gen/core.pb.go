...
const (
	StdType_STDOUT StdType = 0
	StdType_STDERR StdType = 1
)

// Enum value maps for StdType.
var (
	StdType_name = map[int32]string{
		0: "STDOUT",
		1: "STDERR",
	}
	StdType_value = map[string]int32{
		"STDOUT": 0,
		"STDERR": 1,
	}
)

func (x StdType) Enum() *StdType {
	p := new(StdType)
	*p = x
	return p
}
...
func (StdType) Descriptor() protoreflect.EnumDescriptor {
	return file_core_proto_enumTypes[1].Descriptor()
}

func (StdType) Type() protoreflect.EnumType {
	return &file_core_proto_enumTypes[1]
}

func (x StdType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use StdType.Descriptor instead.
func (StdType) EnumDescriptor() ([]byte, []int) {
...
type AttachWorkloadMessage struct {
	...
	StdType    StdType `protobuf:"varint,3,opt,name=std_type,json=stdType,proto3,enum=pb.StdType" json:"std_type,omitempty"`
}
...
func (x *AttachWorkloadMessage) GetStdType() StdType {
	if x != nil {
		return x.StdType
	}
	return StdType_STDOUT
}
...
var file_core_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x74, 0x0a, 0x15, 0x41, 0x74, 0x74,
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x26, 0x0a, 0x08, 0x73, 0x74, 0x64, 0x5f, 0x74,
	0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x53,
	0x74, 0x64, 0x54, 0x79, 0x70, 0x65, 0x52, 0x07, 0x73, 0x74, 0x64, 0x54, 0x79, 0x70, 0x65, 0x22,
	...
	0x6f, 0x77, 0x22, 0x4c, 0x0a, 0x10, 0x4c, 0x6f, 0x67, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d,
	...
	0x05, 0x46, 0x41, 0x4c, 0x53, 0x45, 0x10, 0x02, 0x2a, 0x21, 0x0a, 0x07, 0x53, 0x74, 0x64, 0x54,
	0x79, 0x70, 0x65, 0x12, 0x0a, 0x0a, 0x06, 0x53, 0x54, 0x44, 0x4f, 0x55, 0x54, 0x10, 0x00, 0x12,
	0x0a, 0x0a, 0x06, 0x53, 0x54, 0x44, 0x45, 0x52, 0x52, 0x10, 0x01, 0x32, 0xce, 0x11, 0x0a, 0x07,
	...
	0x2e, 0x4e, 0x6f, 0x64, 0x65, 0x22, 0x00, 0x12, 0x41, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x4e, 0x6f,
...
var file_core_proto_depIdxs = []int32{
	...
	1,   // 72: pb.AttachWorkloadMessage.std_type:type_name -> pb.StdType
	51,  // 73: pb.RunAndWaitOptions.deploy_options:type_name -> pb.DeployOptions
	121, // 74: pb.CapacityMessage.node_capacities:type_name -> pb.CapacityMessage.NodeCapacitiesEntry
	41,  // 75: pb.Builds.BuildsEntry.value:type_name -> pb.Build
	50,  // 76: pb.Resource.VolumePlanLimitEntry.value:type_name -> pb.Volume
	50,  // 77: pb.Resource.VolumePlanRequestEntry.value:type_name -> pb.Volume
	55,  // 78: pb.CopyOptions.TargetsEntry.value:type_name -> pb.CopyPaths
	4,   // 79: pb.CoreRPC.Info:input_type -> pb.Empty
	4,   // 80: pb.CoreRPC.WatchServiceStatus:input_type -> pb.Empty
	12,  // 81: pb.CoreRPC.ListNetworks:input_type -> pb.ListNetworkOptions
	13,  // 82: pb.CoreRPC.ConnectNetwork:input_type -> pb.ConnectNetworkOptions
	14,  // 83: pb.CoreRPC.DisconnectNetwork:input_type -> pb.DisconnectNetworkOptions
	33,  // 84: pb.CoreRPC.AddPod:input_type -> pb.AddPodOptions
	34,  // 85: pb.CoreRPC.RemovePod:input_type -> pb.RemovePodOptions
	35,  // 86: pb.CoreRPC.GetPod:input_type -> pb.GetPodOptions
	4,   // 87: pb.CoreRPC.ListPods:input_type -> pb.Empty
	35,  // 88: pb.CoreRPC.GetPodResource:input_type -> pb.GetPodOptions
	36,  // 89: pb.CoreRPC.AddNode:input_type -> pb.AddNodeOptions
	37,  // 90: pb.CoreRPC.RemoveNode:input_type -> pb.RemoveNodeOptions
	40,  // 91: pb.CoreRPC.ListPodNodes:input_type -> pb.ListNodesOptions
	38,  // 92: pb.CoreRPC.GetNode:input_type -> pb.GetNodeOptions
	20,  // 93: pb.CoreRPC.SetNode:input_type -> pb.SetNodeOptions
	39,  // 94: pb.CoreRPC.GetNodeResource:input_type -> pb.GetNodeResourceOptions
	51,  // 95: pb.CoreRPC.CalculateCapacity:input_type -> pb.DeployOptions
	28,  // 96: pb.CoreRPC.GetWorkload:input_type -> pb.WorkloadID
	29,  // 97: pb.CoreRPC.GetWorkloads:input_type -> pb.WorkloadIDs
	7,   // 98: pb.CoreRPC.ListWorkloads:input_type -> pb.ListWorkloadsOptions
	38,  // 99: pb.CoreRPC.ListNodeWorkloads:input_type -> pb.GetNodeOptions
	29,  // 100: pb.CoreRPC.GetWorkloadsStatus:input_type -> pb.WorkloadIDs
	24,  // 101: pb.CoreRPC.SetWorkloadsStatus:input_type -> pb.SetWorkloadsStatusOptions
	25,  // 102: pb.CoreRPC.WorkloadStatusStream:input_type -> pb.WorkloadStatusStreamOptions
	56,  // 103: pb.CoreRPC.Copy:input_type -> pb.CopyOptions
	57,  // 104: pb.CoreRPC.Send:input_type -> pb.SendOptions
	43,  // 105: pb.CoreRPC.BuildImage:input_type -> pb.BuildImageOptions
	53,  // 106: pb.CoreRPC.CacheImage:input_type -> pb.CacheImageOptions
	54,  // 107: pb.CoreRPC.RemoveImage:input_type -> pb.RemoveImageOptions
	...
	30,  // 110: pb.CoreRPC.RemoveWorkload:input_type -> pb.RemoveWorkloadOptions
	31,  // 111: pb.CoreRPC.DissociateWorkload:input_type -> pb.DissociateWorkloadOptions
	71,  // 112: pb.CoreRPC.ControlWorkload:input_type -> pb.ControlWorkloadOptions
	75,  // 113: pb.CoreRPC.ExecuteWorkload:input_type -> pb.ExecuteWorkloadOptions
	32,  // 114: pb.CoreRPC.ReallocResource:input_type -> pb.ReallocOptions
	73,  // 115: pb.CoreRPC.LogStream:input_type -> pb.LogStreamOptions
	70,  // 116: pb.CoreRPC.RunAndWait:input_type -> pb.RunAndWaitOptions
	...
	8,   // 122: pb.CoreRPC.AddPod:output_type -> pb.Pod
	4,   // 123: pb.CoreRPC.RemovePod:output_type -> pb.Empty
	8,   // 124: pb.CoreRPC.GetPod:output_type -> pb.Pod
	9,   // 125: pb.CoreRPC.ListPods:output_type -> pb.Pods
	10,  // 126: pb.CoreRPC.GetPodResource:output_type -> pb.PodResource
	17,  // 127: pb.CoreRPC.AddNode:output_type -> pb.Node
	4,   // 128: pb.CoreRPC.RemoveNode:output_type -> pb.Empty
	18,  // 129: pb.CoreRPC.ListPodNodes:output_type -> pb.Nodes
	17,  // 130: pb.CoreRPC.GetNode:output_type -> pb.Node
	17,  // 131: pb.CoreRPC.SetNode:output_type -> pb.Node
	11,  // 132: pb.CoreRPC.GetNodeResource:output_type -> pb.NodeResource
	76,  // 133: pb.CoreRPC.CalculateCapacity:output_type -> pb.CapacityMessage
	21,  // 134: pb.CoreRPC.GetWorkload:output_type -> pb.Workload
	27,  // 135: pb.CoreRPC.GetWorkloads:output_type -> pb.Workloads
	21,  // 136: pb.CoreRPC.ListWorkloads:output_type -> pb.Workload
	27,  // 137: pb.CoreRPC.ListNodeWorkloads:output_type -> pb.Workloads
	23,  // 138: pb.CoreRPC.GetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	23,  // 139: pb.CoreRPC.SetWorkloadsStatus:output_type -> pb.WorkloadsStatus
	26,  // 140: pb.CoreRPC.WorkloadStatusStream:output_type -> pb.WorkloadStatusStreamMessage
	67,  // 141: pb.CoreRPC.Copy:output_type -> pb.CopyMessage
	68,  // 142: pb.CoreRPC.Send:output_type -> pb.SendMessage
	59,  // 143: pb.CoreRPC.BuildImage:output_type -> pb.BuildImageMessage
	62,  // 144: pb.CoreRPC.CacheImage:output_type -> pb.CacheImageMessage
	63,  // 145: pb.CoreRPC.RemoveImage:output_type -> pb.RemoveImageMessage
	60,  // 146: pb.CoreRPC.CreateWorkload:output_type -> pb.CreateWorkloadMessage
	61,  // 147: pb.CoreRPC.ReplaceWorkload:output_type -> pb.ReplaceWorkloadMessage
	64,  // 148: pb.CoreRPC.RemoveWorkload:output_type -> pb.RemoveWorkloadMessage
	65,  // 149: pb.CoreRPC.DissociateWorkload:output_type -> pb.DissociateWorkloadMessage
	72,  // 150: pb.CoreRPC.ControlWorkload:output_type -> pb.ControlWorkloadMessage
	69,  // 151: pb.CoreRPC.ExecuteWorkload:output_type -> pb.AttachWorkloadMessage
	66,  // 152: pb.CoreRPC.ReallocResource:output_type -> pb.ReallocResourceMessage
	74,  // 153: pb.CoreRPC.LogStream:output_type -> pb.LogStreamMessage
	69,  // 154: pb.CoreRPC.RunAndWait:output_type -> pb.AttachWorkloadMessage
