...
_PODRESOURCE = _descriptor.Descriptor(
  ...
  nested_types=[_PODRESOURCE_CPUPERCENTSENTRY, _PODRESOURCE_MEMORYPERCENTSENTRY, _PODRESOURCE_VERIFICATIONSENTRY, _PODRESOURCE_DETAILSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
