...
_REPLACEOPTIONS = _descriptor.Descriptor(
  ...
  nested_types=[_REPLACEOPTIONS_FILTERLABELSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
