...
_CLEANPODOPTIONS = _descriptor.Descriptor(
  name='CleanPodOptions',
  full_name='pb.CleanPodOptions',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='podname', full_name='pb.CleanPodOptions.podname', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='prune', full_name='pb.CleanPodOptions.prune', index=1,
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='images', full_name='pb.CleanPodOptions.images', index=2,
...
_CONTAINER = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='inspect', full_name='pb.Container.inspect', index=8,
  ...
  nested_types=[_CONTAINER_CPUENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_DEPLOYOPTIONS_SYSCTLSENTRY = _descriptor.Descriptor(
  name='SysctlsEntry',
  full_name='pb.DeployOptions.SysctlsEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pb.DeployOptions.SysctlsEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='value', full_name='pb.DeployOptions.SysctlsEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_DEPLOYOPTIONS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='sysctls', full_name='pb.DeployOptions.sysctls', index=23,
  ...
  nested_types=[_DEPLOYOPTIONS_NETWORKSENTRY, _DEPLOYOPTIONS_METAENTRY, _DEPLOYOPTIONS_NODELABELSENTRY, _DEPLOYOPTIONS_DATAENTRY, _DEPLOYOPTIONS_SYSCTLSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_DEPLOYOPTIONS_SYSCTLSENTRY.containing_type = _DEPLOYOPTIONS
...
_DEPLOYOPTIONS.fields_by_name['sysctls'].message_type = _DEPLOYOPTIONS_SYSCTLSENTRY
...
DESCRIPTOR.message_types_by_name['CleanPodOptions'] = _CLEANPODOPTIONS
...
CleanPodOptions = _reflection.GeneratedProtocolMessageType('CleanPodOptions', (_message.Message,), dict(
  DESCRIPTOR = _CLEANPODOPTIONS,
  __module__ = 'core_pb2'
  # @@protoc_insertion_point(class_scope:pb.CleanPodOptions)
  ))
_sym_db.RegisterMessage(CleanPodOptions)
...
DeployOptions = _reflection.GeneratedProtocolMessageType('DeployOptions', (_message.Message,), dict(
  ...
  SysctlsEntry = _reflection.GeneratedProtocolMessageType('SysctlsEntry', (_message.Message,), dict(
    DESCRIPTOR = _DEPLOYOPTIONS_SYSCTLSENTRY,
    __module__ = 'core_pb2'
    # @@protoc_insertion_point(class_scope:pb.DeployOptions.SysctlsEntry)
    ))
  ,
...
_sym_db.RegisterMessage(DeployOptions.SysctlsEntry)
...
_DEPLOYOPTIONS_SYSCTLSENTRY.has_options = True
_DEPLOYOPTIONS_SYSCTLSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
...
_CORERPC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='CleanPod',
    full_name='pb.CoreRPC.CleanPod',
    index=4,
    containing_service=None,
    input_type=_CLEANPODOPTIONS,
    output_type=_EMPTY,
    options=None,
  ),
  _descriptor.MethodDescriptor(
