...
AttachContainerMessage = _reflection.GeneratedProtocolMessageType('AttachContainerMessage', (_message.Message,), dict(
...
ExecuteContainerOptions = _reflection.GeneratedProtocolMessageType('ExecuteContainerOptions', (_message.Message,), dict(
