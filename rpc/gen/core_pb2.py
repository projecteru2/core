...
_EXECUTECONTAINERMESSAGE = _descriptor.Descriptor(
  name='ExecuteContainerMessage',
  full_name='pb.ExecuteContainerMessage',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='container_id', full_name='pb.ExecuteContainerMessage.container_id', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='data', full_name='pb.ExecuteContainerMessage.data', index=1,
      number=2, type=12, cpp_type=9, label=1,
      has_default_value=False, default_value=_b(""),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
DESCRIPTOR.message_types_by_name['ExecuteContainerMessage'] = _EXECUTECONTAINERMESSAGE
...
RunAndWaitMessage = _reflection.GeneratedProtocolMessageType('RunAndWaitMessage', (_message.Message,), {
...
ExecuteContainerMessage = _reflection.GeneratedProtocolMessageType('ExecuteContainerMessage', (_message.Message,), {
  'DESCRIPTOR' : _EXECUTECONTAINERMESSAGE,
  '__module__' : 'core_pb2'
  # @@protoc_insertion_point(class_scope:pb.ExecuteContainerMessage)
  })
_sym_db.RegisterMessage(ExecuteContainerMessage)
...
_CORERPC = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    output_type=_EXECUTECONTAINERMESSAGE,
    serialized_options=None,
  ),
  _descriptor.MethodDescriptor(
