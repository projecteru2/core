...
_CREATECONTAINERMESSAGE_NETWORKSENTRY = _descriptor.Descriptor(
  name='NetworksEntry',
  full_name='pb.CreateContainerMessage.NetworksEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='pb.CreateContainerMessage.NetworksEntry.key', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='value', full_name='pb.CreateContainerMessage.NetworksEntry.value', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CREATECONTAINERMESSAGE = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='networks', full_name='pb.CreateContainerMessage.networks', index=8,
      number=9, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
  ...
  nested_types=[_CREATECONTAINERMESSAGE_CPUENTRY, _CREATECONTAINERMESSAGE_NETWORKSENTRY, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_CREATECONTAINERMESSAGE_NETWORKSENTRY.containing_type = _CREATECONTAINERMESSAGE
_CREATECONTAINERMESSAGE.fields_by_name['cpu'].message_type = _CREATECONTAINERMESSAGE_CPUENTRY
_CREATECONTAINERMESSAGE.fields_by_name['networks'].message_type = _CREATECONTAINERMESSAGE_NETWORKSENTRY
...
CreateContainerMessage = _reflection.GeneratedProtocolMessageType('CreateContainerMessage', (_message.Message,), dict(
  ...
  NetworksEntry = _reflection.GeneratedProtocolMessageType('NetworksEntry', (_message.Message,), dict(
    DESCRIPTOR = _CREATECONTAINERMESSAGE_NETWORKSENTRY,
    __module__ = 'core_pb2'
    # @@protoc_insertion_point(class_scope:pb.CreateContainerMessage.NetworksEntry)
    ))
  ,
...
_sym_db.RegisterMessage(CreateContainerMessage.NetworksEntry)
...
_CREATECONTAINERMESSAGE_NETWORKSENTRY.has_options = True
_CREATECONTAINERMESSAGE_NETWORKSENTRY._options = _descriptor._ParseOptions(descriptor_pb2.MessageOptions(), _b('8\001'))
