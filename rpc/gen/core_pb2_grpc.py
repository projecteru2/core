...
class CoreRPCStub(object):
  ...
  def __init__(self, channel):
    ...
    self.UpgradeContainer = channel.unary_stream(
        ...
        request_serializer=core__pb2.UpgradeOptions.SerializeToString,
        response_deserializer=core__pb2.UpgradeContainerMessage.FromString,
        )
...
def add_CoreRPCServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'UpgradeContainer': grpc.unary_stream_rpc_method_handler(
          ...
          request_deserializer=core__pb2.UpgradeOptions.FromString,
          response_serializer=core__pb2.UpgradeContainerMessage.SerializeToString,
      ),
