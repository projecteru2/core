...
func (v *Vibranium) GetNodeResource(ctx context.Context, opts *pb.GetNodeFixOptions) (*pb.NodeResource, error) {
	nr, err := v.cluster.NodeResource(ctx, opts.GetGetNodeOptions().Nodename, opts.Fix)
	if err != nil {
		return nil, err
	}
