...
func (_m *API) ResourceValidate(ctx context.Context, cpu float64, cpumap map[string]int, memory int64, storage int64) error {
	ret := _m.Called(ctx, cpu, cpumap, memory, storage)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, float64, map[string]int, int64, int64) error); ok {
