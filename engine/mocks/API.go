...
func (_m *API) ImageBuild(ctx context.Context, input io.Reader, refs []string) (io.ReadCloser, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, io.Reader, []string) (io.ReadCloser, error)); ok {
		return rf(ctx, input, refs)
	}
...
func (_m *API) VirtualizationResourceRemap(_a0 context.Context, _a1 *types.VirtualizationRemapOptions) (<-chan types.VirtualizationRemapMessage, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *types.VirtualizationRemapOptions) (<-chan types.VirtualizationRemapMessage, error)); ok {
		return rf(_a0, _a1)
	}
