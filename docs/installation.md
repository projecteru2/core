...
curl -fsSL -o core.tar.gz \
  https://github.com/projecteru2/core/releases/download/v0.1.5/core_0.1.5_Linux_x86_64.tar.gz
...
```shell
docker pull ghcr.io/projecteru2/core:v0.1.5   # or projecteru2/core:v0.1.5
```
