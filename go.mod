...
//COPY FROM YAVIRT
replace (
	//To import calico we need to replace all the missing version in calico/go.mod
	github.com/projectcalico/api => github.com/projectcalico/calico/api v0.0.0-20220304232216-f9b0b64b0e75
