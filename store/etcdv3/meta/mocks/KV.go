...
func (_m *KV) BatchCreate(ctx context.Context, data map[string]string, opts ...clientv3.OpOption) (*clientv3.TxnResponse, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, map[string]string, ...clientv3.OpOption) (*clientv3.TxnResponse, error)); ok {
...
func (_m *KV) BatchDelete(ctx context.Context, keys []string, opts ...clientv3.OpOption) (*clientv3.TxnResponse, error) {
	...
	var r0 *clientv3.TxnResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, ...clientv3.OpOption) (*clientv3.TxnResponse, error)); ok {
...
func (_m *KV) Create(ctx context.Context, key string, val string, opts ...clientv3.OpOption) (*clientv3.TxnResponse, error) {
	...
	var r0 *clientv3.TxnResponse
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, ...clientv3.OpOption) (*clientv3.TxnResponse, error)); ok {
...
func (_m *KV) GetMulti(ctx context.Context, keys []string, opts ...clientv3.OpOption) ([]*mvccpb.KeyValue, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []string, ...clientv3.OpOption) ([]*mvccpb.KeyValue, error)); ok {
		return rf(ctx, keys, opts...)
	}
