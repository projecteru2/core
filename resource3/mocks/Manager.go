...
func (_m *Manager) GetNodeMetrics(_a0 context.Context, _a1 *types.Node) ([]*pluginstypes.Metrics, error) {
	ret := _m.Called(_a0, _a1)

	var r0 []*pluginstypes.Metrics
	if rf, ok := ret.Get(0).(func(context.Context, *types.Node) []*pluginstypes.Metrics); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
...
func (_m *Manager) GetNodeResourceInfo(_a0 context.Context, _a1 string, _a2 []*types.Workload, _a3 bool) (*types.Resources, *types.Resources, []string, error) {
	ret := _m.Called(_a0, _a1, _a2, _a3)

	var r0 *types.Resources
	if rf, ok := ret.Get(0).(func(context.Context, string, []*types.Workload, bool) *types.Resources); ok {
		r0 = rf(_a0, _a1, _a2, _a3)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*types.Resources)
	...
	var r1 *types.Resources
	if rf, ok := ret.Get(1).(func(context.Context, string, []*types.Workload, bool) *types.Resources); ok {
		r1 = rf(_a0, _a1, _a2, _a3)
	} else {
		if ret.Get(1) != nil {
			r1 = ret.Get(1).(*types.Resources)
