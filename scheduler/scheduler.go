...
type Scheduler interface {
	...
	SelectCPUNodes(scheduleInfos []resourcetypes.ScheduleInfo, quota float64, memory int64, existCPUInfo map[string]types.CPUMap) ([]resourcetypes.ScheduleInfo, map[string][]types.CPUMap, int, error)
